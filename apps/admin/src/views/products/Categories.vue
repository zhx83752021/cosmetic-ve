<template>
    <div class="categories-page">
        ...
        <el-card shadow="never">
            <el-table :data="tableData" border v-loading="loading" row-key="id" :tree-props="{ children: 'children' }">
        ...
        <el-dialog v-model="dialogVisible" :title="dialogTitle" width="600px" @close="handleDialogClose">
            <el-form ref="formRef" :model="formData" :rules="rules" label-width="100px">
                ...
                <el-form-item label="上级分类">
                    <el-tree-select v-model="formData.parentId" :data="categoryTree"
                        :props="{ label: 'name', value: 'id' }" placeholder="选择上级分类（不选为顶级分类）" clearable
                        check-strictly />
                </el-form-item>
...
import { getCategories, createCategory, updateCategory, deleteCategory, type Category } from '@/api/product'
