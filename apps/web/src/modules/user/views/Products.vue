  ...
  <div class="products-page min-h-screen bg-gray-50 pt-20">
    ...
    <main class="container py-8">
      ...
      <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">发现为您精心挑选的高端化妆品</p>
      </div>
      ...
      <div class="flex flex-col gap-8 lg:flex-row">
           ...
           <div class="rounded-xl bg-white p-6 shadow-sm">
             ...
             <div class="space-y-2">
               <button 
                 ...
                 :class="['w-full text-left px-3 py-2 rounded-lg text-sm transition-colors', filters.category === 'all' ? 'bg-primary text-white' : 'hover:bg-gray-100']"
               >
                 全部产品
               </button>
               <!-- 这里也可以改为动态渲染 -->
        ...
        <div class="flex-1">
            ...
            <!-- 空状态 -->
            <div v-else class="flex min-h-[400px] flex-col items-center justify-center rounded-xl bg-white shadow-sm">
