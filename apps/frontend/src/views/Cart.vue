        ...
        <div class="mb-8 flex items-center justify-between">
          <div>
            ...
            <p class="mt-2 text-sm text-gray-600">
              {{ cartStore.items.length > 0 ? `共 ${cartStore.items.length} 件商品` : '还没有添加商品' }}
            </p>
          </div>
            ...
            <div class="card">
              <div class="flex items-center justify-between p-4">
                <label class="flex items-center cursor-pointer group">
                  ...
                  <span class="font-medium text-gray-900 group-hover:text-primary transition-colors">全选</span>
                </label>
            ...
            <div class="card sticky top-24 shadow-lg">
              ...
              <div class="space-y-4 border-b border-gray-200 pb-5">
                ...
                <div class="flex justify-between">
                  ...
                  <span class="font-medium text-gray-900">¥{{ cartStore.selectedTotalPrice.toFixed(2) }}</span>
                </div>
                <div class="flex justify-between items-center">
                  <span class="text-gray-600">运费</span>
                  <span v-if="shippingFee === 0" class="font-medium text-green-600">免运费 🎉</span>
                  <span v-else class="font-medium text-gray-900">¥{{ shippingFee.toFixed(2) }}</span>
                </div>
              </div>
              ...
              <div class="px-3">
                <button
                  ...
                  <span v-else class="flex items-center justify-center gap-2">
                    <span>💳</span>
                    <span>去结算 ({{ selectedItemCount }})</span>
                  </span>
                </button>
              </div>
                  ...
                  <div class="flex items-start gap-2">
                    ...
                    <div class="flex-1">
                      ...
                      <p v-if="cartStore.selectedTotalPrice < 299" class="mt-1 text-sm text-gray-600">
                        再买 <span class="font-semibold text-primary">¥{{ (299 - cartStore.selectedTotalPrice).toFixed(2)
                        }}</span> 即可免运费
                      </p>
                      <p v-else class="mt-1 text-sm text-green-600">✓ 已享受免运费</p>
                    </div>
                  </div>
                </div>
